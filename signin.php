    ...
    <header></header>
     ...
     <li> <a href='submit.html' class='link'>Home</a></li>
        ...
        <div class='men1'>
            ...
            <h1>Visit Home:<button type='submit' name=button style='height: 45px; width:150px; font-size:18px;'>Click here</button>
            <br>
...
if($res==0)
{
    echo" <h1>Login not successful..";
        echo"<br>To sign in again <a href='signin.html'>'click here'</a>";
